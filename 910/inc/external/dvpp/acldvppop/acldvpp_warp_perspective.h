...
#endif
/**
* @brief acldvppWarpPerspective的第一阶段接口，根据具体的计算流程，计算workspace大小。
...
/**
* @brief acldvppWarpPerspective的第二阶段接口，用于执行计算。
* @param [in] workspace: 在npu device侧申请的workspace内存起址。
* @param [in] workspaceSize: 在npu device侧申请的workspace大小，由第一段接口acldvppWarpPerspectiveGetWorkspaceSize获取。
