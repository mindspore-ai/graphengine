...
*@par Inputs:
*@li grad: A 4-D Tensor with shape `[batch, channels, out_height, out_width]`.
*@li x: A 4-D Tensor with shape `[batch, channels, height, width]`.
*@li grid: flow field grid, 4-D Tensor with shape `[batch, out_height, out_width, 2]`.
...
*@li padding_mode: An optional string specifying the pad method, either "zeros", "border", or "reflection". 
 Defaults to "zeros".
*@li align_corners: An optional bool. If "true", the centers of the corner
 pixels of the input and output tensors are aligned. Defaults to false.

*@par Outputs:
*@li dx: Returns 4-D Tensor with the same dtype and shape as `x`.
*@li dgrid: Returns 4-D Tensor with the same dtype and shape as `grid`.
