...
*@li code_type: An optional int, specify the code type. Defaults to 1(only 
*supports 2). The corner is 1, center_size is 2, corner_size is 3.
...
*Inputs include:
* @li boxes: A Tensor. Must be float16 or float32.
* @li anchors: A Tensor. Must be float16 or float32.
*
*@par Attributes:
