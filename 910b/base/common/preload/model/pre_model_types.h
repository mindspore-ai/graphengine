...
const std::map<uint32_t, std::string> kTaskTypeToEngineName = {
    ...
    {static_cast<uint32_t>(RT_MODEL_TASK_STREAM_LABEL_SWITCH_BY_INDEX), kPreEngineNanoAiCore},
    {static_cast<uint32_t>(RT_MODEL_TASK_STREAM_LABEL_GOTO), kPreEngineNanoAiCore},
