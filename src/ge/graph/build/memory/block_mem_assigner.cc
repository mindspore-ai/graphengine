...
void BlockMemAssigner::InitReusableStreamMap() {
  ...
  FindDependantStream(stream_head_tail_node_map, stream_dependency_map);
...
void BlockMemAssigner::FindDependantStream(map<int64_t, pair<NodePtr, NodePtr>> &stream_head_tail_node_map,
                                           map<int64_t, unordered_set<int64_t>> &stream_dependency_map) {
