...
#ifndef GE_HYBRID_HOST_AICPU_KERNEL_VARIABLE_KERNEL_H_
#define GE_HYBRID_HOST_AICPU_KERNEL_VARIABLE_KERNEL_H_
...
#endif  // GE_HYBRID_HOST_AICPU_KERNEL_VARIABLE_KERNEL_H_
