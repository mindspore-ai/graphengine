...
TEST_F(UTEST_ge_anchor_utils, base) {
  ...
  ComputeGraphPtr graphPtr1 = std::make_shared<ComputeGraph>("name");
  n1 = graphPtr1->AddNode(descPtr1);
  NodePtr n2 = graphPtr1->AddNode(descPtr2);
