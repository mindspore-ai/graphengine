...
namespace ge {
namespace formats {
class UTEST_DataTypeTransfer : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown() {}
};

TEST_F(UTEST_DataTypeTransfer, fp16_fp32) {
  fp16_t data[1 * 4 * 4 * 2] = {
...
TEST_F(UTEST_DataTypeTransfer, int32_fp16) {
...
TEST_F(UTEST_DataTypeTransfer, fp32_fp16) {
...
TEST_F(UTEST_DataTypeTransfer, int8_fp32) {
  int8_t data[2 * 4 * 5 * 3] = {
...
TEST_F(UTEST_DataTypeTransfer, int8_int32) {
  int8_t data[2 * 4 * 5 * 3] = {
      0, 1, 2, 1, 2, 3, 2, 3, 4, 3, 4, 5, 4, 5, 6, 1, 2, 3, 2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7,
      2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7, 6, 7, 8, 3, 4, 5, 4, 5, 6, 5, 6, 7, 6, 7, 8, 7, 8, 9,
      1, 2, 3, 2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7, 2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7, 6, 7, 8,
...
TEST_F(UTEST_DataTypeTransfer, uint8_fp32) {
...
TEST_F(UTEST_DataTypeTransfer, uint8_int32) {
  uint8_t data[1 * 4 * 4 * 3] = {
      2,  6,  1, 6, 11, 12, 30, 24, 4,  28, 22, 25, 20, 5,  18, 15, 23, 27, 1,  25, 26, 24, 11, 8,
      21, 15, 6, 5, 23, 17, 11, 18, 21, 24, 14, 20, 19, 12, 23, 16, 3,  9,  10, 3,  15, 31, 18, 9,
  };
...
TEST_F(UTEST_DataTypeTransfer, fp32_int32) {
  float data[2 * 3 * 2 * 2] = {
...
TEST_F(UTEST_DataTypeTransfer, int32_fp32) {
...
TEST_F(UTEST_DataTypeTransfer, int32_uint8) {
...
TEST_F(UTEST_DataTypeTransfer, int32_int8) {
  int32_t data[2 * 4 * 5 * 3] = {
      0, 1, 2, 1, 2, 3, 2, 3, 4, 3, 4, 5, 4, 5, 6, 1, 2, 3, 2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7,
      2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7, 6, 7, 8, 3, 4, 5, 4, 5, 6, 5, 6, 7, 6, 7, 8, 7, 8, 9,
      1, 2, 3, 2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7, 2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7, 6, 7, 8,
...
TEST_F(UTEST_DataTypeTransfer, InvalidSrcDataType) {
...
TEST_F(UTEST_DataTypeTransfer, SrcShapeEmpry) {
  uint8_t data[1 * 4 * 4 * 1] = {0};
...
TEST_F(UTEST_DataTypeTransfer, UnsupprotTrans) {
  bool data[1 * 4 * 4 * 1] = {0};
...
TEST_F(UTEST_DataTypeTransfer, UnsupprotTrans2) {
  bool data[1 * 4 * 4 * 1] = {0};
