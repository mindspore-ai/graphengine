...
namespace ge {
namespace formats {
class UTEST_FormatTransferFracZHwcn : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown() {}
};

TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidDatatype_InvalidDatatype) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidSrcFormat_RESERVED) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidDstFormat_RESERVED) {
  float data[16 * 1 * 16 * 16] = {1};
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidSrcShape) {
  float data[16 * 1 * 16 * 16] = {1};
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidSrcShape2) {
  float data[16 * 1 * 16 * 16] = {1};
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidDstShape) {
  float data[16 * 1 * 16 * 16] = {1};
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidDstShape2) {
  float data[16 * 1 * 16 * 16] = {1};
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidSrcDstShapeRelation1) {
  float data[16 * 1 * 16 * 16] = {1};
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_InvalidSrcDstShapeRelation2) {
  float data[16 * 1 * 16 * 16] = {1};
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_Fp16_Success_LtCube) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_Fp16_Success_EqCube) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_Fp16_Success_GtCube) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_Fp32_Success_LtCube) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_Fp32_Success_EqCube) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, FracZToHwcn_Fp32_Success_GtCube) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, uint8_1c_2n_padcn) {
...
TEST_F(UTEST_FormatTransferFracZHwcn, fp16_1c_1n_pad_cn) {
