...
class UTEST_FormatTransfer : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown() {}
};

TEST_F(UTEST_FormatTransfer, BuildTransferSuccess) {
...
TEST_F(UTEST_FormatTransfer, BuildUnsupportedTransfer) {
  uint8_t data[1 * 3 * 224 * 224 * 2];
...
TEST_F(UTEST_FormatTransfer, GetSizeByDataType) {
