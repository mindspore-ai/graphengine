...
namespace ge {
class LogicalStreamAllocatorTest : public testing::Test {
 protected:
  void SetUp() {}
  ...
  Status AssignLogicalStreams(vector<SubGraphInfoPtr> subgraphs, vector<EngineConfPtr> &confs,
    ...
    for (auto &item : scheduler_conf.cal_engines) {
...
TEST_F(LogicalStreamAllocatorTest, TestSingleSubgraph) {
...
TEST_F(LogicalStreamAllocatorTest, TestSingleSubgraphWithLabel) {
...
TEST_F(LogicalStreamAllocatorTest, TestSameEngine) {
...
TEST_F(LogicalStreamAllocatorTest, TestDiffEngine) {
  SubGraphInfoPtr data = CreateDataSubgraph();
...
TEST_F(LogicalStreamAllocatorTest, TestEngineAttach) {
  SubGraphInfoPtr data = CreateDataSubgraph();
  SubGraphInfoPtr subgraph1 = CreateSubgraphWithName("graph1", "engine1", "");
...
TEST_F(LogicalStreamAllocatorTest, TestSkipAssignStream) {
  SubGraphInfoPtr data = CreateDataSubgraph();
  SubGraphInfoPtr subgraph1 = CreateSubgraph("engine1", "");
  SubGraphInfoPtr subgraph2 = CreateSubgraph("engine2", "");
  SubGraphInfoPtr subgraph3 = CreateSubgraph("engine3", "");
...
TEST_F(LogicalStreamAllocatorTest, TestStreamLabel) {
  SubGraphInfoPtr data = CreateDataSubgraph();
...
TEST_F(LogicalStreamAllocatorTest, TestLabelNotReusable) {
  SubGraphInfoPtr data = CreateDataSubgraph();
...
///   \   /
///    sub3
TEST_F(LogicalStreamAllocatorTest, TestLabelNotReusable2) {
  SubGraphInfoPtr data = CreateDataSubgraph();
  SubGraphInfoPtr subgraph1 = CreateSubgraphWithName("graph1", "engine1", "label1");
...
///    /  |   \
/// sub2 sub3 sub4
TEST_F(LogicalStreamAllocatorTest, TestMultiOutNewStream) {
  SubGraphInfoPtr data = CreateDataSubgraph();
...
///    /   |   |   \
/// sub2 sub3 sub4 sub5
TEST_F(LogicalStreamAllocatorTest, TestParallelOne) {
  SubGraphInfoPtr data = CreateDataSubgraph();
...
///    /   |   |   \
/// sub2 sub3 sub4 sub5
TEST_F(LogicalStreamAllocatorTest, TestIndependent) {
  SubGraphInfoPtr data = CreateDataSubgraph();
  SubGraphInfoPtr subgraph1 = CreateSubgraph("engine1", "", 1, 4);
  SubGraphInfoPtr subgraph2 = CreateSubgraph("engine1");
  SubGraphInfoPtr subgraph3 = CreateSubgraph("engine2");
...
///    /   |   |   \
/// sub2 sub3 sub4 sub5
TEST_F(LogicalStreamAllocatorTest, TestIndependentSwitchLabel) {
  SubGraphInfoPtr data = CreateDataSubgraph();
...
///   |    /
/// domask3
TEST_F(LogicalStreamAllocatorTest, TestNoInput) {
...
///   |    /
/// domask3
TEST_F(LogicalStreamAllocatorTest, TestConstInput) {
  auto data = CreateDataSubgraph();
  auto const1 = CreateConstSubgraph();
  auto const2 = CreateConstSubgraph();
...
TEST_F(LogicalStreamAllocatorTest, TestAllParallelNum1) { TestAll(1); }

TEST_F(LogicalStreamAllocatorTest, TestAllParallelNum2) { TestAll(2); }

TEST_F(LogicalStreamAllocatorTest, TestReusableSubgraphNotAssignedStream) {
  SubGraphInfoPtr data = CreateDataSubgraph();
  SubGraphInfoPtr subgraph1 = CreateSubgraphWithName("graph1", "engine1", "");
  SubGraphInfoPtr subgraph2 = CreateSubgraphWithName("graph2", "engine1", "");
  LinkSubGraph(data, "end", subgraph1, "placeholder");
...
///   |
/// subgrah3(label)
TEST_F(LogicalStreamAllocatorTest, TestReAssignStream) {
  SubGraphInfoPtr data = CreateDataSubgraph();
...
TEST_F(LogicalStreamAllocatorTest, TestAllReduceParallelPass) {
