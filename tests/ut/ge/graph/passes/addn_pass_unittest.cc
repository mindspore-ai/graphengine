...
TEST(UTEST_graph_passes_addn_pass, NullPass) {
...
TEST(UTEST_graph_passes_addn_pass, NullGraph) {
...
TEST(UTEST_graph_passes_addn_pass, EmptyPass) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  GEPass pass(graph);
  AddNPass addn_pass;
  NamesToPass names_to_pass;
...
///   AddN
///    |
TEST(UTEST_graph_passes_addn_pass, SingleAddNNode) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  GeTensorDescPtr generalGeTensorDesc = std::make_shared<GeTensorDesc>();
...
///  AddN
///    |
TEST(UTEST_graph_passes_addn_pass, NoOuput) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  GeTensorDescPtr generalGeTensorDesc = std::make_shared<GeTensorDesc>();
...
///      |
///     Op
TEST(UTEST_graph_passes_addn_pass, NoInput) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  GeTensorDescPtr generalGeTensorDesc = std::make_shared<GeTensorDesc>();
...
///      |
///     Op2
TEST(UTEST_graph_passes_addn_pass, SingleInputRemoveAddnSuccess) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  GeTensorDescPtr generalGeTensorDesc = std::make_shared<GeTensorDesc>();
...
///        |
///       Op3
TEST(UTEST_graph_passes_addn_pass, MultipleInputsDoNotRemove) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  GeTensorDescPtr generalGeTensorDesc = std::make_shared<GeTensorDesc>();
