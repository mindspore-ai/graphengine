...
namespace ge {
class UTEST_graph_passes_assert_pass : public Test {
 protected:
...
///                :
///                B
TEST_F(UTEST_graph_passes_assert_pass, assert_pass_test1) {
  ...
  Status status = assertPass.Run(node_a);
...
///                    :
///                    B
TEST_F(UTEST_graph_passes_assert_pass, assert_pass_test2) {
...
///           :
///           B
TEST_F(UTEST_graph_passes_assert_pass, assert_pass_test3) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test1");
