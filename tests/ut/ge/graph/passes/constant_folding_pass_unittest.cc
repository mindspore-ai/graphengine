...
class UTEST_graph_passes_constant_folding_pass : public testing::Test {
 protected:
  UTEST_graph_passes_constant_folding_pass() = default;
};
...
TEST_F(UTEST_graph_passes_constant_folding_pass, FoldingAddN) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, FoldingWithoutOneConst) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, FoldingWithConstControlEdges) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, ContinuesFold) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, MultipleOutput) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, NotChange1) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, NotChange2) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, FoldingSize) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, Unlikely1) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, Unlikely2) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, Unlikely3) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, Unlikely4) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, Unlikely5) {
...
TEST_F(UTEST_graph_passes_constant_folding_pass, Unlikely6) {
