...
TEST_F(UTEST_graph_passes_dimension_adjust_pass, succ) {
...
TEST_F(UTEST_graph_passes_dimension_adjust_pass, input_node_is_nullptr) {
  std::shared_ptr<DimensionAdjustPass> pass = make_shared<DimensionAdjustPass>();
...
TEST_F(UTEST_graph_passes_dimension_adjust_pass, node_op_desc_is_nullptr) {
...
TEST_F(UTEST_graph_passes_dimension_adjust_pass, node_get_original_type_failed) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
...
TEST_F(UTEST_graph_passes_dimension_adjust_pass, node_not_register_op) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
  OpDescPtr expanddim_op_desc = std::make_shared<OpDesc>("Expanddims", FRAMEWORKOP);
...
TEST_F(UTEST_graph_passes_dimension_adjust_pass, node_compute_failed) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
