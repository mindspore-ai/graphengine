...
class UTEST_graph_passes_enter_pass : public testing::Test {
 protected:
  void BuildGraph() {
    // Tensor
...
TEST_F(UTEST_graph_passes_enter_pass, null_input) {
  NodePtr node = nullptr;
  EXPECT_EQ(pass_.Run(node), PARAM_INVALID);
}

TEST_F(UTEST_graph_passes_enter_pass, run_success) {
