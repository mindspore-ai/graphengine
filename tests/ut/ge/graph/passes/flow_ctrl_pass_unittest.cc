...
namespace ge {
class UTEST_graph_passes_flow_ctrl_pass : public testing::Test {
 protected:
  void SetUp() {
    ...
    EXPECT_EQ(domi::SUCCESS, ge::VarManager::Instance(0)->Init(session_version, session_id, device_id, job_id));
  }
 ...
 public:
  ...
  void AddSessionVariables(void) {
    static std::set<std::string> varList = {
    ...
    for (std::string var_name : varList) {
      EXPECT_EQ(domi::SUCCESS, ge::VarManager::Instance(0)->SetVarAddr(var_name, tensor_desc, dev_ptr, RT_MEMORY_HBM));
    }
  }
};

TEST_F(UTEST_graph_passes_flow_ctrl_pass, FlowCtrlPass_Success_Test) {
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, FlowCtrlPass_Success_VAR_NODE_ADD_BEFORE) {
  ge::ComputeGraphPtr graph = make_shared<ge::ComputeGraph>("FlowCtrlPassSuccess");
  graph->SetNeedIteration(true);
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, FlowCtrlPass_NOT_TRAIN) {
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, AddFpBpIteratorCtrl_WITHOUT_VAR) {
  ge::ComputeGraphPtr graph = make_shared<ge::ComputeGraph>("TestNotChange");
  graph->SetNeedIteration(true);
  // Create graph
  MakeGraph(graph);
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, Run_AddSpecialNodeIteratorCtrl_NO_INANCHOR) {
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, AddFpBpIteratorCtrl_WITHOUT_LOOP_COND) {
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, AddFpBpIteratorCtrl_WITHOUT_LOOP_INCREMENT) {
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, AddFpBpIteratorCtrl_WITHOUT_LOOP_RESETVALUE) {
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, AddFpBpIteratorCtrl_WITHOUT_LOOP_PER_ITER) {
  ge::ComputeGraphPtr graph = make_shared<ge::ComputeGraph>("Test_WITHOUT_LOOP_PER_ITER");
  graph->SetNeedIteration(true);
  // Create graph
  MakeGraph(graph);
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, AddSpecialNodeIteratorCtrl_WITHOUT_LOOP_COND) {
  ge::ComputeGraphPtr graph = make_shared<ge::ComputeGraph>("Test_WITHOUT_LOOP_COND");
  graph->SetNeedIteration(true);
  // Create graph
  MakeGraph(graph);
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, AddSpecialNodeIteratorCtrl_WITHOUT_LOOP_PER_ITER) {
  ge::ComputeGraphPtr graph = make_shared<ge::ComputeGraph>("Test_WITHOUT_LOOP_PER_ITER");
  graph->SetNeedIteration(true);
  // Create graph
  MakeGraph(graph);
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, AddSpecialNodeIteratorCtrl_NO_INANCHOR) {
  ge::ComputeGraphPtr graph = make_shared<ge::ComputeGraph>("Test_WITHOUT_LOOP_PER_ITER");
  graph->SetNeedIteration(true);
  // Create graph
  MakeGraph(graph);
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, InsertAssignOp_SUCCESS) {
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, InsertAssignOp_REF_NODE_NO_OUTANCHOR) {
  ge::ComputeGraphPtr graph = make_shared<ge::ComputeGraph>("Test_InsertAssignOp");
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, InsertAssignOp_VALUE_NODE_NO_OUTANCHOR) {
  ge::ComputeGraphPtr graph = make_shared<ge::ComputeGraph>("Test_InsertAssignOp");
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, CreateIterCtrlFalseBranch_InsertAssignOp_FAILED) {
...
TEST_F(UTEST_graph_passes_flow_ctrl_pass, CreateIterCtrlTrueBranch_InsertAssignOp_FAILED) {
