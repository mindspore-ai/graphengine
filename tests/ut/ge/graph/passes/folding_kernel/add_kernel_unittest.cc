...
class UTEST_folding_kernel_add_kernel : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_folding_kernel_add_kernel, add_optimizer_int_success) {
...
TEST_F(UTEST_folding_kernel_add_kernel, add_optimizer_int32_scalar) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Add", ADD);
  vector<bool> is_input_const_vec = {
      true,
      true,
...
TEST_F(UTEST_folding_kernel_add_kernel, add_optimizer_float_success) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Add", ADD);
  vector<bool> is_input_const_vec = {
      true,
      true,
...
TEST_F(UTEST_folding_kernel_add_kernel, add_optimizer_errtype_success) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Add", ADD);
  vector<bool> is_input_const_vec = {
      true,
      true,
