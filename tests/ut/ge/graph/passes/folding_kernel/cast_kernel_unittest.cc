...
class UTEST_graph_passes_folding_kernel_cast_kernel : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_folding_kernel_cast_kernel, compute_param_invalid_1) {
...
TEST_F(UTEST_graph_passes_folding_kernel_cast_kernel, compute_param_invalid_2) {
...
TEST_F(UTEST_graph_passes_folding_kernel_cast_kernel, compute_success_float_to_float16) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Cast", "Cast");
...
TEST_F(UTEST_graph_passes_folding_kernel_cast_kernel, compute_success_int64_to_int32) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Cast", "Cast");
...
TEST_F(UTEST_graph_passes_folding_kernel_cast_kernel, compute_float_to_float16_fail) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Cast", "Cast");
...
TEST_F(UTEST_graph_passes_folding_kernel_cast_kernel, compute_float_to_float16_fail2) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Cast", "Cast");
...
TEST_F(UTEST_graph_passes_folding_kernel_cast_kernel, compute_not_support) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Cast", "Cast");
...
TEST_F(UTEST_graph_passes_folding_kernel_cast_kernel, compute_shape_empty_success) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Cast", "Cast");
