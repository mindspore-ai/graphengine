...
class UTEST_graph_passes_folding_kernel_floormod_kernel : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_folding_kernel_floormod_kernel, floormod_optimizer_int_success) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("floormod", FLOORMOD);
...
TEST_F(UTEST_graph_passes_folding_kernel_floormod_kernel, floormod_optimizer_errtype_fail) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("floormod", FLOORMOD);
  vector<bool> is_input_const_vec = {true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
...
TEST_F(UTEST_graph_passes_folding_kernel_floormod_kernel, floormod_optimizer_different_type) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("floormod", FLOORMOD);
  vector<bool> is_input_const_vec = {true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, ATTR_NAME_T, (int64_t)DT_INT32);
...
TEST_F(UTEST_graph_passes_folding_kernel_floormod_kernel, floormod_null) {
  vector<int64_t> dims_vec_0;
  ...
  op_desc_ptr = make_shared<OpDesc>("floormod", FLOORMOD);
  vector<bool> is_input_const_vec = {true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, ATTR_NAME_T, (int64_t)DT_INT32);
...
TEST_F(UTEST_graph_passes_folding_kernel_floormod_kernel, floormod_zero) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("floormod", FLOORMOD);
  vector<bool> is_input_const_vec = {true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, ATTR_NAME_T, (int64_t)DT_INT32);
