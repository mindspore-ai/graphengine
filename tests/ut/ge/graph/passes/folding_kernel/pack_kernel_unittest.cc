...
class UTEST_graph_passes_folding_kernel_pack_kernel : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, test_1) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, test_2) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
  vector<bool> is_input_const_vec = {true, true, true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, test_3) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
  vector<bool> is_input_const_vec = {true, true, true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, PACK_ATTR_NAME_NUM, (int64_t)4);
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, test_4) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
  vector<bool> is_input_const_vec = {true, true, true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, PACK_ATTR_NAME_NUM, (int64_t)4);
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, test_5) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
  vector<bool> is_input_const_vec = {true, true, true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, PACK_ATTR_NAME_NUM, (int64_t)4);
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, pack_optimizer_success_int) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
  vector<bool> is_input_const_vec = {true, true, true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, PACK_ATTR_NAME_NUM, (int64_t)4);
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, pack_optimizer_success_int_1) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, pack_optimizer_success_float) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
  vector<bool> is_input_const_vec = {true, true, true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, PACK_ATTR_NAME_NUM, (int64_t)4);
...
TEST_F(UTEST_graph_passes_folding_kernel_pack_kernel, pack_optimizer_failed_errtype) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("pack", "Pack");
  vector<bool> is_input_const_vec = {true, true, true, true};
  op_desc_ptr->SetIsInputConst(is_input_const_vec);
  AttrUtils::SetInt(op_desc_ptr, PACK_ATTR_NAME_NUM, (int64_t)4);
