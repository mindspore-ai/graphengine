...
class UTEST_graph_passes_folding_kernel_reshape_kernel : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, int8_int32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, int16_int32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, int32_int32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, int64_int32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, uint8_int32) {
  vector<int64_t> data_vec = {2, 3};
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, uint16_int32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, uint32_int32) {
  vector<int64_t> data_vec = {3, 3, 3, 5, 6};
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, uint64_int32) {
  vector<int64_t> data_vec = {6, 1, 12, 3, 4, 56, 7};
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, fp16_int32) {
  vector<int64_t> data_vec = {6, 1, 12, 3, 4, 56, 7};
  vector<int32_t> dim_value_vec = {-1};
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, float_int32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, double_int32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, double_int64) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, bool_int64) {
  vector<int64_t> data_vec = {3, 4, 2, 2, 8};
  vector<int64_t> dim_value_vec = {12, -1};
  vector<int64_t> result = {12, 32};
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, invalid_format) {
  vector<int64_t> data_vec = {2, 3};
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, node_is_null) {
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, invalid_input_node_size) {
  vector<int64_t> data_vec = {1, 1, 1, 11, 1, 1, 1};
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, folding_int64_success) {
  vector<int64_t> data_vec = {3, 4, 2, 2, 8};
  vector<int64_t> dim_value_vec = {12, -1};
  vector<int64_t> result = {12, 32};
...
TEST_F(UTEST_graph_passes_folding_kernel_reshape_kernel, opdesc_is_null_failed) {
  shared_ptr<Kernel> kernel = KernelFactory::Instance().Create(RESHAPE);
