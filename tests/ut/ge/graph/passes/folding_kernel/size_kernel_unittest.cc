...
class UTEST_graph_passes_folding_kernel_size_kernel : public testing::Test {
 protected:
  void SetUp() { init(); }
...
TEST_F(UTEST_graph_passes_folding_kernel_size_kernel, size_optimizer_success) {
...
TEST_F(UTEST_graph_passes_folding_kernel_size_kernel, size_2_input_fail) {
...
TEST_F(UTEST_graph_passes_folding_kernel_size_kernel, size_input_not_set_data_type_fail) {
  vector<int64_t> dims_vec_0 = {8, 2};
  GeTensorDesc tensor_desc_0(GeShape(dims_vec_0), FORMAT_NCHW, DT_FLOAT);
  op_desc_ptr_->AddInputDesc(tensor_desc_0);
...
TEST_F(UTEST_graph_passes_folding_kernel_size_kernel, size_input_int64_overflow) {
...
TEST_F(UTEST_graph_passes_folding_kernel_size_kernel, opdesc_is_nullptr) {
