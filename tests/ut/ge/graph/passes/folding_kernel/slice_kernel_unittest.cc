...
class UTEST_folding_slice_kernel : public testing::Test {
 protected:
  void SetUp() { init(); }
...
TEST_F(UTEST_folding_slice_kernel, slice_optimizer_int_success) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  NodePtr node = initNode_int32(graph);
  domi::Status ret = pass_->Run(node);
...
/// result： optimize op of slice success
TEST_F(UTEST_folding_slice_kernel, slice_optimizer_float_success) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
/// result： optimize op of slice success
TEST_F(UTEST_folding_slice_kernel, slice_optimizer_errtype_success) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
/// result： optimize op of slice success
TEST_F(UTEST_folding_slice_kernel, slice_optimizer_int_muldims) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
/// result： optimize op of slice success
TEST_F(UTEST_folding_slice_kernel, slice_optimizer_int_3muldims) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
/// result： optimize op of slice success
TEST_F(UTEST_folding_slice_kernel, slice_optimizer_int_2muldims) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
/// result： optimize op of slice success
TEST_F(UTEST_folding_slice_kernel, slice_optimizer_int_1muldims) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
/// result： optimize op of slice success
TEST_F(UTEST_folding_slice_kernel, slice_optimizer_size_not_equal) {
  ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
