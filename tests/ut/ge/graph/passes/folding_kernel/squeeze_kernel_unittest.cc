...
class UTEST_graph_passes_folding_kernel_squeeze_kernel : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int8_case_0) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int8_case_1) {
  vector<int64_t> data_vec = {1, 1, 1, 2, 3};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int8_case_2) {
  vector<int64_t> data_vec = {1, 1, 1, 2, 3};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int8_negative_case_1) {
  vector<int64_t> data_vec = {1, 1, 1, 2, 3};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int8_negative_case_2) {
  vector<int64_t> data_vec = {1, 1, 1, 2, 3};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int8_negative_case_3) {
  vector<int64_t> data_vec = {1, 1, 1, 2, 3};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int16) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, int64) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, uint8) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, uint16) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, uint32) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, uint64) {
  vector<int64_t> data_vec = {6, 1, 12, 3, 4, 56, 7};
  vector<int32_t> dim_value_vec = {1};
  vector<int64_t> result = {6, 12, 3, 4, 56, 7};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, fp16) {
  vector<int64_t> data_vec = {6, 1, 12, 3, 4, 56, 7};
  vector<int32_t> dim_value_vec = {1};
  vector<int64_t> result = {6, 12, 3, 4, 56, 7};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, float) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, double) {
  vector<int64_t> data_vec = {1, 1, 1, 11, 1, 1, 1};
  vector<int32_t> dim_value_vec = {0, 1, 2, 4, 5, 6};
  vector<int64_t> result = {11};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, node_is_null) {
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, bool_int64) {
  vector<int64_t> data_vec = {1, 1, 1, 11, 1, 1, 1};
  vector<int32_t> dim_value_vec = {0, 1, 2, 4, 5, 6};
  vector<int64_t> result = {11};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, double_not_attr) {
  vector<int64_t> data_vec = {1, 1, 1, 11, 1, 1, 1};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, double_contain_same_dims) {
  vector<int64_t> data_vec = {1, 1, 1, 11, 1, 1, 1};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, double_contain_same_dims_invalid_format) {
  vector<int64_t> data_vec = {1, 1, 1, 11, 1, 1, 1};
  vector<int32_t> dim_value_vec = {0, 1, 0};
  vector<int64_t> result = {1, 11, 1, 1, 1};
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, const_folding_success) {
  auto graph = BuildGraph();
  std::vector<GeTensorPtr> v_output;
  std::vector<ConstGeTensorPtr> inputs;
  ConstGeTensorPtr data_tensor = make_shared<const GeTensor>();
...
TEST_F(UTEST_graph_passes_folding_kernel_squeeze_kernel, const_folding_unsuccess) {
  auto graph = BuildGraph();
  std::vector<GeTensorPtr> v_output;
  std::vector<ConstGeTensorPtr> inputs;
