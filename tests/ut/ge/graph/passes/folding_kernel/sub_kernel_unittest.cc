...
class UTEST_folding_kernel_sub_kernel : public testing::Test {
 protected:
  void SetUp() {}
...
/// result： success
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_float) {
  ...
  domi::Status status = kernel->Compute(test_op, input, v_output);
  EXPECT_EQ(domi::SUCCESS, status);
}
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_int16) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_double) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_int8) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_uint8) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_uint16) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_int32) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_int64) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_uint32) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, com_success_uint64) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
TEST_F(UTEST_folding_kernel_sub_kernel, string_com_fail_notchange) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
  ge::GeShape sub_shape({1});
...
/// case：optimize op of SUB
/// result： failed
TEST_F(UTEST_folding_kernel_sub_kernel, com_failed) {
  OpDescPtr test_op = std::make_shared<OpDesc>("test", "Test");
  vector<ConstGeTensorPtr> input;
  vector<GeTensorPtr> v_output;
