...
class UTEST_graph_passes_folding_kernel_transdata_kernel : public testing::Test {
 protected:
  void SetUp() {}
...
/// result： success
TEST_F(UTEST_graph_passes_folding_kernel_transdata_kernel, compute_param_invalid_1) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Transdata", "Transdata");
...
TEST_F(UTEST_graph_passes_folding_kernel_transdata_kernel, compute_param_invalid_2) {
...
TEST_F(UTEST_graph_passes_folding_kernel_transdata_kernel, compute_param_invalid_3) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Transdata", "Transdata");
...
TEST_F(UTEST_graph_passes_folding_kernel_transdata_kernel, compute_1) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Transdata", "Transdata");
...
TEST_F(UTEST_graph_passes_folding_kernel_transdata_kernel, compute_2) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Transdata", "Transdata");
...
TEST_F(UTEST_graph_passes_folding_kernel_transdata_kernel, compute_3) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Transdata", "Transdata");
...
TEST_F(UTEST_graph_passes_folding_kernel_transdata_kernel, compute_4) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Transdata", "Transdata");
...
TEST_F(UTEST_graph_passes_folding_kernel_transdata_kernel, compute_5) {
  OpDescPtr op_desc_ptr = make_shared<OpDesc>("Transdata", "Transdata");
