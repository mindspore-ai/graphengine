...
class UTEST_identity_pass : public Test {
 protected:
...
TEST_F(UTEST_identity_pass, succ) {
...
TEST_F(UTEST_identity_pass, skip_merge) {
  ...
  EXPECT_EQ(pass.Run(names_to_pass), domi::SUCCESS);
...
TEST_F(UTEST_identity_pass, skip_switch) {
...
TEST_F(UTEST_identity_pass, norm_after_switch) {
