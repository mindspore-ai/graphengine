...
class UTEST_graph_passes_net_output_pass : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown() {}
};
...
TEST_F(UTEST_graph_passes_net_output_pass, add_ctrl_edge_for_netout_from_leaf_success) {
...
TEST_F(UTEST_graph_passes_net_output_pass, only_target_node_success) {
...
TEST_F(UTEST_graph_passes_net_output_pass, targets_with_retval_success) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, output_node_and_target_node_no_duplicate_success) {
  ge::ComputeGraphPtr compute_graph = build_graph(true);
...
TEST_F(UTEST_graph_passes_net_output_pass, output_node_and_target_node_duplicate_success) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, netoutput_node_and_target_node_success) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, netoutput_node_and_output_nodes_and_target_node_success_1) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
/// include one common node with target nodes.
/// Notice: output nodes set is more prio
TEST_F(UTEST_graph_passes_net_output_pass, netoutput_node_and_output_nodes_and_target_node_success_2) {
  ge::ComputeGraphPtr compute_graph = build_graph(true);
...
/// include one common node with target nodes.
/// Notice: output nodes set is more prio
TEST_F(UTEST_graph_passes_net_output_pass, netoutput_node_and_output_nodes_and_target_node_success_3) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, no_output_no_target_no_retval_success) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, user_out_node_success) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, retval_node_for_out_success) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, check_order_and_const_flag_success) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, out_node_check_fail) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, retval_node_check_fail) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, out_node_update_desc_check_fail) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, out_node_remove_check_fail) {
  ge::ComputeGraphPtr compute_graph = build_graph();
...
TEST_F(UTEST_graph_passes_net_output_pass, clear_weight) {
