...
class UTEST_Graph_no_reshape_op_remove_pass : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown() {}
};
...
TEST_F(UTEST_Graph_no_reshape_op_remove_pass, node_to_be_delete_success) {
...
TEST_F(UTEST_Graph_no_reshape_op_remove_pass, reshape_for_sfc_net_success) {
