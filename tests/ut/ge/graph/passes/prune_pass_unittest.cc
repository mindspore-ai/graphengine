...
class UTEST_graph_passes_prune_pass : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_prune_pass, no_net_out_put_node) {
...
TEST_F(UTEST_graph_passes_prune_pass, has_net_out_put_node_with_only_one_path) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
...
TEST_F(UTEST_graph_passes_prune_pass, has_net_out_put_node_with_one_valid_path_and_one_bypass_path) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
...
TEST_F(UTEST_graph_passes_prune_pass, has_net_out_put_node_with_multi_path) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
...
TEST_F(UTEST_graph_passes_prune_pass, multi_net_out_put_node_with_circle_net) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
...
TEST_F(UTEST_graph_passes_prune_pass, mix_two_circle_net) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
...
TEST_F(UTEST_graph_passes_prune_pass, has_net_out_put_node_with_two_isolate_data_node) {
  ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("default");
