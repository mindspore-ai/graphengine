...
namespace ge {
class UTEST_ReshapeRemovePass : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown() {}
};
...
TEST_F(UTEST_ReshapeRemovePass, ReshapeRemoveWithConst) {
...
TEST_F(UTEST_ReshapeRemovePass, ReshapeRemoveWithConstTwoReshape) {
...
TEST_F(UTEST_ReshapeRemovePass, ReshapeRemoveWithoutConst) {
