...
class UTEST_graph_passes_shape_operate_op_remove_pass : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_shape_operate_op_remove_pass, squeeze_and_squeeze) {
  ...
  domi::Status status = shape_operate_op_pass.Run(graph);
