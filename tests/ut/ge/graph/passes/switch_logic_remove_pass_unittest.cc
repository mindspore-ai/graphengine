...
namespace ge {
class UTEST_SwitchLogicRemovePass : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown() {}
};
...
TEST_F(UTEST_SwitchLogicRemovePass, RemoveTheSameTrue) {
...
TEST_F(UTEST_SwitchLogicRemovePass, RemoveDifferent) {
  SwitchLogicRemovePass pass;
  NamesToPass names_to_pass;
  names_to_pass.emplace_back("SwitchLogicRemovePass", &pass);
...
TEST_F(UTEST_SwitchLogicRemovePass, NoNeedToOptimize) {
  SwitchLogicRemovePass pass;
  NamesToPass names_to_pass;
  names_to_pass.emplace_back("SwitchLogicRemovePass", &pass);
...
TEST_F(UTEST_SwitchLogicRemovePass, BothTrueAndFalse) {
  SwitchLogicRemovePass pass;
  NamesToPass names_to_pass;
  names_to_pass.emplace_back("SwitchLogicRemovePass", &pass);
