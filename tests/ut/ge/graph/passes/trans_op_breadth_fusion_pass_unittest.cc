...
class UTEST_graph_passes_trans_op_breadth_fusion_pass : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, test_simple_trans_data) {
  ...
  domi::Status status = pass.Run(graph);
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, test_simple_cast) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, test_simple_reshape) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, test_simple_transpose) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, test_partial_matching) {
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, test_control_anchor) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, test_reshape_op_failed) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, test_multi_anchor_case) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, diff_stream1) {
...
TEST_F(UTEST_graph_passes_trans_op_breadth_fusion_pass, diff_stream2) {
