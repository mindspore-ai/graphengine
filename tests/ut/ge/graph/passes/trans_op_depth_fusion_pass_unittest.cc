...
class UTEST_graph_passes_trans_op_depth_fusion_pass : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_offset_cast) {
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_offset_cast_ctrl_edge) {
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_offset_cast_ctrl_edge2) {
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_offset_cast_ctrl_edge3) {
  // Node4D(fp32)->sinh1->cast1(fp32->fp16)->cast2(fp16->fp32)->sinh2->sinh3
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_offset_cast_ctrl_edge4) {
  //  Node4D(fp32)->sinh1->sinh2->cast1(fp32->fp16)->cast2(fp16->fp32)->sinh3
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_offset_transpose) {
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_offset_transdata) {
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_fold_reshape) {
...
TEST_F(UTEST_graph_passes_trans_op_depth_fusion_pass, test_transop_with_multi_out_edge) {
  /// input graph
  ///
  ///                                 -->sih1
  ///                                /
