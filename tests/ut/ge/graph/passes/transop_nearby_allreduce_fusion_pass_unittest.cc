...
TEST(UTEST_transop_nearby_allreduce_fusion_pass, test1_NullGraph) {
...
TEST(UTEST_transop_nearby_allreduce_fusion_pass, test2_NullNode) {
...
TEST(UTEST_transop_nearby_allreduce_fusion_pass, test3_OnlyAllreduce) {
...
TEST(UTEST_transop_nearby_allreduce_fusion_pass, test4_AllReduceWithTransData) {
  ///    TransData
  ///        |
  ///  HcomAllReduce
  ///         |
...
TEST(UTEST_transop_nearby_allreduce_fusion_pass, test5_AllReduceWithSymmetricTransDataAndRelu) {
  ///       relu
  ///         |
  ///     TransData
  ///         |
...
TEST(UTEST_transop_nearby_allreduce_fusion_pass, test6_AllReduceWithAsymmetricTransDataAndRelu) {
  ///       relu
  ///         |
  ///     TransData
  ///         |
...
TEST(UTEST_transop_nearby_allreduce_fusion_pass, test7_AllReduceWithMultipleTransDatasAndOtherOps) {
  ///    TransData   TransData     ...       MatMul      ...
  ///        \         |           /       /           /
  ///              HcomAllReduce
  ///         /         |           \       \           \
...
TEST(UTEST_transop_nearby_allreduce_fusion_pass, test8_InAndOutDataAnchorAreNotEqual) {
  /// HcomAllReduce
  ///       |
  ///    TransData
