...
class VariableOpPassUnittest : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(VariableOpPassUnittest, testTransDataRemove) {
...
TEST_F(VariableOpPassUnittest, testVariableRef) {
  VariableOpPassSimulator varibale_op_pass_simulator;
...
TEST_F(VariableOpPassUnittest, testNullGraph) {
  VariableOpPassSimulator varibale_op_pass_simulator;
...
TEST_F(VariableOpPassUnittest, testCovarageTransVarData) {
  VariableOpPassSimulator varibale_op_pass_simulator;
...
TEST_F(VariableOpPassUnittest, testIllegallyRef) {
  VariableOpPassSimulator varibale_op_pass_simulator;
...
TEST_F(VariableOpPassUnittest, testSingleNode) {
  VariableOpPassSimulator varibale_op_pass_simulator;
...
TEST_F(VariableOpPassUnittest, testUnMathed) {
  VariableOpPassSimulator varibale_op_pass_simulator;
...
TEST_F(VariableOpPassUnittest, testSameOp) {
  VariableOpPassSimulator varibale_op_pass_simulator;
...
TEST_F(VariableOpPassUnittest, testErrorReturn) {
  VariableOpPassSimulator varibale_op_pass_simulator;
...
TEST_F(VariableOpPassUnittest, Reshape) {
  // init
  MemManager::Instance().Initialize(std::vector<rtMemType_t>({RT_MEMORY_HBM}));
...
TEST_F(VariableOpPassUnittest, ReFormat) {
  // init
  MemManager::Instance().Initialize(std::vector<rtMemType_t>({RT_MEMORY_HBM}));
  VarManager::Instance(0)->Init(0, 0, 0, 0);
...
TEST_F(VariableOpPassUnittest, InvalidSrcShape2) {
