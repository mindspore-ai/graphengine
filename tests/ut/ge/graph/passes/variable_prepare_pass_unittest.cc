...
using namespace ge;
class UTEST_graph_passes_variable_prepare_pass : public testing::Test {
 protected:
  void SetUp() {}
...
///   \       /
///     assign
TEST_F(UTEST_graph_passes_variable_prepare_pass, variable_prepare_pass_succ1) {
...
TEST_F(UTEST_graph_passes_variable_prepare_pass, variable_prepare_pass_succ2) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  ge::NodePtr variable_node = NodeBuilder("variable", VARIABLE)
                                  .AddInputDesc({2, 16, 2, 2}, FORMAT_NHWC, DT_FLOAT)
                                  .AddOutputDesc({2, 16, 2, 2}, FORMAT_NHWC, DT_FLOAT)
...
///              \          /
///               assign_add3
TEST_F(UTEST_graph_passes_variable_prepare_pass, variable_prepare_pass_succ3) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  ge::NodePtr variable_node = NodeBuilder("variable", VARIABLE)
                                  .AddInputDesc({2, 16, 2, 2}, FORMAT_NHWC, DT_FLOAT)
                                  .AddOutputDesc({2, 16, 2, 2}, FORMAT_NHWC, DT_FLOAT)
