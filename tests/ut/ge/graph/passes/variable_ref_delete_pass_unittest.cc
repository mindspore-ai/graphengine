...
class UTEST_graph_passes_variable_ref_delete_pass : public testing::Test {
 protected:
  void SetUp() {}
...
///       |
///   variable_ref
TEST_F(UTEST_graph_passes_variable_ref_delete_pass, variable_ref_delete_pass_succ1) {
...
///       |
///   variable_ref
TEST_F(UTEST_graph_passes_variable_ref_delete_pass, variable_ref_delete_pass_fail1) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
  ge::NodePtr variable_node = NodeBuilder("variable", VARIABLE)
                                  .AddInputDesc({2, 16, 2, 2}, FORMAT_NHWC, DT_FLOAT)
                                  .AddOutputDesc({2, 16, 2, 2}, FORMAT_NHWC, DT_FLOAT)
...
///       |
///   variable_ref
TEST_F(UTEST_graph_passes_variable_ref_delete_pass, variable_ref_delete_pass_fail2) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
