...
class UTEST_transop_util : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(UTEST_transop_util, test_is_transop_true) {
...
TEST_F(UTEST_transop_util, test_is_transop_fail) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
...
TEST_F(UTEST_transop_util, test_get_transop_get_index) {
  ge::ComputeGraphPtr graph = std::make_shared<ComputeGraph>("test");
