...
namespace ge {
class VariableAccelerateCtrlUT : public testing::Test {
 protected:
  void SetUp() {}
  void TearDown() {}
};
...
TEST_F(VariableAccelerateCtrlUT, AddGraphNullPtr) {
  VarAccelerateCtrl c;
  c.AddGraph(1, nullptr);
  EXPECT_TRUE(c.graph_ids_to_var_names_.empty());
}

TEST_F(VariableAccelerateCtrlUT, AddGraphNoVar) {
  VarAccelerateCtrl c;
...
TEST_F(VariableAccelerateCtrlUT, AddGraphVars) {
  VarAccelerateCtrl c;
...
TEST_F(VariableAccelerateCtrlUT, RemoveGraphVars) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
...
TEST_F(VariableAccelerateCtrlUT, GraphRebuild) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
...
TEST_F(VariableAccelerateCtrlUT, GraphRebuildMultiChanged) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
  EXPECT_FALSE(c.IsGraphNeedRebuild(1));
...
TEST_F(VariableAccelerateCtrlUT, GraphRebuildMultiGraph) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
...
TEST_F(VariableAccelerateCtrlUT, GraphRebuildAfterRemoveGraph) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
  c.AddGraph(2, BuildGraph2());
  EXPECT_FALSE(c.IsGraphNeedRebuild(1));
...
TEST_F(VariableAccelerateCtrlUT, GraphRebuildAfterBuildEnd) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
  c.AddGraph(2, BuildGraph2());
  EXPECT_FALSE(c.IsGraphNeedRebuild(1));
...
TEST_F(VariableAccelerateCtrlUT, VarPermitToChange) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
...
TEST_F(VariableAccelerateCtrlUT, VarPermitToChangeRemoveGraphDoNotChangeIt) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
  EXPECT_TRUE(c.IsVarPermitToChangeFormats("var1"));
  EXPECT_TRUE(c.IsVarPermitToChangeFormats("var2"));
...
TEST_F(VariableAccelerateCtrlUT, VarPermitToChangeExccedsTheMaxNum) {
  VarAccelerateCtrl c;
  c.AddGraph(1, BuildGraph2());
  EXPECT_TRUE(c.IsVarPermitToChangeFormats("var1"));
  EXPECT_TRUE(c.IsVarPermitToChangeFormats("var2"));
...
TEST_F(VariableAccelerateCtrlUT, VarChangedBeforeAddGraph) {
  VarAccelerateCtrl c;
  EXPECT_TRUE(c.IsVarPermitToChangeFormats("var1"));
  EXPECT_TRUE(c.IsVarPermitToChangeFormats("var2"));
  EXPECT_TRUE(c.IsVarPermitToChangeFormats("var3"));
