...
class StreamResourceTest : public testing::Test {
 protected:
  void SetUp() {}
...
TEST_F(StreamResourceTest, TestCacheOp) {
  StreamResource res;
...
TEST_F(StreamResourceTest, TestMallocMemory) {
  StreamResource res;
...
TEST_F(StreamResourceTest, TestDoMallocMemory) {
